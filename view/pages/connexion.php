<div class="formulaire" ng-controller="FormController as form">
	...
	<form ng-show="form.isSet(1)" id="co_part" action="index.php?page=connexion" method="post">
	...
	<form ng-show="form.isSet(2)" id="co_orga" action="index.php?page=connexion" method="post">
